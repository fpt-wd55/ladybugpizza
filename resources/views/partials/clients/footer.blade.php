<footer class="border-t p-4 md:px-8 lg:px-24 md:py-4">
    <div class="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center">
        ...
        <div>
            <ul class="space-y-4">
                <li><a href="#" class="uppercase hover:text-red-500 transition text-sm font-semibold">trang chủ</a></li>
                <li><a href="#" class="uppercase hover:text-red-500 transition text-sm font-semibold">thực đơn</a></li>
                <li><a href="#" class="uppercase hover:text-red-500 transition text-sm font-semibold">về chúng tôi</a></li>
            </ul>
        </div>
        <div>
            <ul class="space-y-4">
                <li><a href="#" class="uppercase hover:text-red-500 transition text-sm font-semibold">liên hệ</a></li>
                <li><a href="#" class="uppercase hover:text-red-500 transition text-sm font-semibold">hướng dẫn mua hàng</a></li>
                <li><a href="#" class="uppercase hover:text-red-500 transition text-sm font-semibold">chính sách và điều khoản</a></li>
            </ul>
        </div>
    </div>
</footer>
