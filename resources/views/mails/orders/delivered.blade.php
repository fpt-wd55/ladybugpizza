                    ...
                    <tr>
                        <td style="padding: 30px; text-align: center; border-bottom: 1px solid #e5e5e5;">
                            ...
                            <p style="margin: 10px 0 0; font-size: 16px; color: #666; line-height: 1.5;">
                                Chúng tôi rất vui khi thông báo rằng đơn hàng của bạn đã được giao tới địa chỉ của bạn
                                thành công. 🍕
                            </p>
                            <p style="margin: 10px 0 0; font-size: 16px; color: #666; line-height: 1.5;">
                                Chúng tôi hy vọng bạn sẽ thích những chiếc pizza nóng hổi và thơm ngon này. Chúc bạn có
                                một bữa ăn tuyệt vời!
                            </p>
                            <p style="margin: 10px 0 0; font-size: 16px; color: #666; line-height: 1.5;">
                                Cảm ơn bạn đã lựa chọn Ladybug Pizza, và hy vọng sẽ phục vụ bạn trong những lần sau!
                            </p>
