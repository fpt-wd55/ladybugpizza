                ...
                <table role="presentation"
                    ...
                    <tr>
                        <td style="padding: 30px; text-align: center; border-bottom: 1px solid #e5e5e5;">
                            <h2 style="margin: 0; font-size: 18px; font-weight: bold; color: #D30A0A;">Đơn hàng của bạn
                                đã bị hủy tại Ladybug Pizza 😔</h2>
                            ...
                            <p style="margin: 10px 0 0; font-size: 16px; color: #666; line-height: 1.5;">
                                Rất tiếc, chúng tôi phải thông báo rằng đơn hàng của bạn đã bị hủy. 😔
                            </p>
                            <p style="margin: 10px 0 0; font-size: 16px; color: #666; line-height: 1.5;">
                                Nếu bạn gặp bất kỳ vấn đề gì, đừng ngần ngại liên hệ với chúng tôi để được hỗ trợ. Chúng
                                tôi rất tiếc vì sự bất tiện này và hy vọng sẽ có cơ hội phục vụ bạn trong tương lai.
                            </p>
