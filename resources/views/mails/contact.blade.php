...
<head>
    ...
    <title>Thông báo từ form Liên Hệ</title>
                ...
                <table role="presentation"
                    ...
                    <tr>
                        <td style="padding: 30px; text-align: center; border-bottom: 1px solid #e5e5e5;">
                            <h2 style="margin: 0; font-size: 18px; font-weight: bold; color: #0E9F6E;">
                                Một người dùng đã liên hệ đến cửa hàng bạn có những thông tin sau:
                            </h2>
                            <p style="margin: 0; margin-top: 15px; font-size: 16px; color: #666;">
                                <strong>Họ và tên:</strong> {{ $contactData['fullname'] }}
                            </p>
                            <p style="margin: 0; margin-top: 10px; font-size: 16px; color: #666; line-height: 1.5;">
                                <strong>Số điện thoại:</strong> {{ $contactData['phone'] }}
                            </p>
                            <p style="margin: 0; margin-top: 10px; font-size: 16px; color: #666; line-height: 1.5;">
                            ...
                            <p style="margin: 0; margin-top: 10px; font-size: 16px; color: #666; line-height: 1.5;">
                                <strong>Nội dung:</strong> {{ $contactData['message'] }}
                            </p>
                        </td>
                    </tr>
                    <tr>
