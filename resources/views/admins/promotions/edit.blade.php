            ...
            <form action="{{ route('admin.promotions.update', $editPromotion->id) }}" class="w-full" method="post"
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input type="number" name="points" class="input" value="{{ $editPromotion->points }}" min="0"
                               placeholder="VD: 50"/>
                        @error('points')
                        <p class="mt-2 text-sm text-red-600 ">
                            {{ $message }}
                    ...
                    <div>
                        ...
                        <select class="w-full select" name="discount_type" id="discount_type">
                            ...
                            <option value="1"
                                {{ old('discount_type', $editPromotion->discount_type) == '1' ? 'selected' : '' }}>Giảm
                                giá
                                theo
                                %
                            </option>
                            <option value="2"
                                {{ old('discount_type', $editPromotion->discount_type) == '2' ? 'selected' : '' }}>Giảm
                                giá
                                theo
                                số
                                tiền
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-3">
                    <div>
                        <label for="discount_value" class="label-md">Giá trị giảm giá <span
                                class="text-red-500">*</span></label>
                        <input type="number" name="discount_value" class="input" placeholder="VD: 10" min="0"
                    ...
                    <div>
                        <label for="start_date" class="label-md">Ngày bắt đầu <span
                                class="text-red-500">*</span></label>
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-3">
                    <div>
                        ...
                        <input type="number" name="quantity" class="input" value="{{ $editPromotion->quantity }}" min="0"
                               placeholder="VD: 14"/>
                        @error('quantity')
                        <p class="mt-2 text-sm text-red-600 ">
                            {{ $message }}
                    ...
                    <div>
                        ...
                        <input type="number" name="min_order_total" class="input" placeholder="VD: 100000" min="0"
                    ...
                    <div>
                        ...
                        <input type="number" name="max_discount" class="input" placeholder="VD: 50000" min="0"
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <label class="inline-flex cursor-pointer items-center">
                            ...
                            <input
                                {{ old('status', $editPromotion->status) == 1 ? 'checked' : '' }} class="peer sr-only"
