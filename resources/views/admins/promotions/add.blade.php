            ...
            <form action="{{ route('admin.promotions.store') }}" class="w-full" enctype="multipart/form-data" method="post">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-3">
                    <div>
                        <label class="label-md" for="discount_value">Giá trị giảm giá <span
                                class="text-red-500">*</span></label>
                        <input class="input" name="discount_value" placeholder="VD: 10" type="text"
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-3">
                    <div>
                        ...
                        <input class="input" name="quantity" placeholder="VD: 14" type="number"
                            value="{{ old('quantity') }}" />
                        @error('quantity')
                            <p class="mt-2 text-sm text-red-600 ">
                                {{ $message }}
                    ...
                    <div>
                        ...
                        <input class="input" name="min_order_total" placeholder="VD: 100000" type="text"
                    ...
                    <div>
                        ...
                        <input class="input" name="max_discount" placeholder="VD: 50000" type="text"
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div>
                        ...
                        <select class="select" name="is_global">
                            <option value="">Chọn</option>
                            <option {{ old('is_global', $promotion->is_global ?? '') == '1' ? 'selected' : '' }}
                                value="1">
                                Tất cả</option>
                            <option {{ old('rank_id', $promotion->rank_id ?? '') == '1' ? 'selected' : '' }}
                                value="2|1">Rank
                                đồng
                            </option>
                            <option {{ old('rank_id', $promotion->rank_id ?? '') == '2' ? 'selected' : '' }}
                                value="2|2">Rank
                                bạc
                            </option>
                            <option {{ old('rank_id', $promotion->rank_id ?? '') == '3' ? 'selected' : '' }}
                                value="2|3">Rank
                                vàng
                            </option>
                            <option {{ old('rank_id', $promotion->rank_id ?? '') == '4' ? 'selected' : '' }}
                                value="2|4">Rank
                                kim cương
                            </option>
                        </select>
