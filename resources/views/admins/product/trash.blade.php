...
@section('content')
    {{ Breadcrumbs::render('admin.product.trash') }}
        ...
        <div
            ...
            <div
                ...
                <div class="flex items-center space-x-3 w-full md:w-full">
                    <form method="POST" action="{{ route('admin.products.bulkAction') }}">
                        @csrf
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                ...
                                <div class="px-4 md:px-6">
                                    ...
                                    <ul class="space-y-2 text-sm">
                                        ...
                                        <li class="flex items-center">
                                            <input id="product_discount" type="checkbox" name="filter_product_discount"
                                                value="1"
                                                class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-0"
                            ...
                            <td class="w-4 px-4 py-3">
                                <div class="flex items-center">
                                    <input id="table-item-checkbox-{{ $product->id }}" type="checkbox"
                                        onclick="event.stopPropagation()" value="{{ $product->id }}"
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="{{ $product->sku }}-dropdown"
                                    ...
                                    <ul class="py-1 text-sm text-gray-700" aria-labelledby="{{ $product->sku }}">
                                        <li>
                                            <span data-modal-target="restore-modal-{{ $product->sku }}"
                                                data-modal-toggle="restore-modal-{{ $product->sku }}"
                                ...
                                {{-- Modal khôi phục --}}
                                <div id="restore-modal-{{ $product->sku }}" tabindex="-1"
                                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow">
                                            <button type="button"
                                                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                                                data-modal-hide="restore-modal-{{ $product->sku }}">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <h3 class="mb-5 font-normal">Bạn có muốn khôi phục sản phẩm này không?</h3>

                                                <div class="flex justify-center items-center">
                                                    <form action="{{ route('admin.restore-product', $product) }}"
                                                        method="POST">
                                                        @csrf
                                                        <button type="submit"
                                                    ...
                                                    <button data-modal-hide="restore-modal-{{ $product->sku }}"
                                                        type="button"
                                ...
                                <div id="destroy-modal-{{ $product->sku }}" tabindex="-1"
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow">
                                            <button type="button"
                                                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                                                data-modal-hide="destroy-modal-{{ $product->sku }}">
                                                @svg('tabler-x', 'w-4 h-4')
                                                <span class="sr-only">Close modal</span>
                                            </button>
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <div class="flex justify-center items-center">
                                                    ...
                                                    <button data-modal-hide="destroy-modal-{{ $product->sku }}"
                                                        type="button"
                                                        class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-0">
                                                        Không
                                                    </button>
