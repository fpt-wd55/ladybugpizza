        ...
        <div class="overflow-x-auto ">
            <div
                ...
                <div
                    ...
                    <a href="{{ route('admin.trash.listcate') }}" class="button-red">
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex items-center w-full md:w-auto">
                        ...
                        <form action="{{ route('admin.categories.filter') }}" method="get" id="filterDropdown"
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-2 text-gray-900 whitespace-nowrap ">
                                    <a class="shrink-0" data-fslightbox="gallery"
                                        ...
                                        <img loading="lazy"
                                            src="{{ asset('storage/uploads/categories/' . $item->image) }}"
