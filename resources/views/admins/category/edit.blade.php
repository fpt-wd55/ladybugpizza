            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{$category->name}}" 
                        ...
                        placeholder="Ex. Pizza Hawaiian">
                        
                        @error('name')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Lỗi! </span> {{$message}}</p>
                            
                        @enderror
                </div>
                <div>
                    <label for="name" class="block mb-2 text-base font-medium text-gray-900 ">Slug</label>
                ...
                <div class="">
                    ...
                    <div class="flex items-center">
                        <label for="status-toggle" class="inline-flex relative items-center cursor-pointer">
                            <input type="checkbox" id="status-toggle" name="status" class="sr-only peer" {{$category->status == 1 ? 'checked' : '' }} value="1">
