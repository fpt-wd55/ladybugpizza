        ...
        <div
            ...
            <div
                ...
                <div class="flex items-center w-full md:w-auto">
                    ...
                    <form action="{{ route('admin.users.filter') }}" method="get" id="filterDropdown" tabindex="-1"
                        aria-hidden="true"
                                        ...
                                        <div class="grid grid-cols-2 gap-2 md:grid-cols-3">
                                            <li class="flex items-center">
                                                <input id="male" type="checkbox" name="filter_gender[]" value="1"
                                                    ...
                                                    class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-0">
                                                <label for="male"
                                                    class="ml-2 text-sm font-medium text-gray-900">Nam</label>
                                            </li>
                                            <li class="flex items-center">
                                                <input id="female" type="checkbox" name="filter_gender[]" value="2"
                                                    ...
                                                    class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-0">
                                                <label for="female"
                                                    class="ml-2 text-sm font-medium text-gray-900">Nữ</label>
                                            </li>
                                            <li class="flex items-center">
                                                <input id="other" type="checkbox" name="filter_gender[]" value="3"
                                                    ...
                                                    class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-0">
                                                <label for="other"
                                                    class="ml-2 text-sm font-medium text-gray-900">Khác</label>
                                            </li>
                                        </div>
                                    </ul>
