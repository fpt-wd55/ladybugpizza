                ...
                <div class="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
                    <div class="space-y-4">
                        ...
                        <dl>
                                                        ...
                                                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                            ...
                                                            <div class="sm:col-span-2">
                                                                ...
                                                                <input type="text" name="detail_address"
                                                                    id="detail_address" placeholder="Địa chỉ chi tiết"
                            ...
                            @endfor
                            <dd>
                                <button class="flex items-center my-3 gap-1 text-blue-500"
                                    data-modal-target="add-address" data-modal-toggle="add-address">
