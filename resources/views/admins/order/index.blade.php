            ...
            <div
                ...
                <div class="flex items-center justify-end gap-3">
                    <button class="button-light flex w-full items-center justify-center"
                            data-modal-target="filterDropdown"
                                    ...
                                    <div class="grid grid-cols-2 gap-2 md:grid-cols-3">
                                        @foreach ($orderStatuses as $status)
                                            <li class="flex items-center">
                                                <input
                                                    @if (in_array($status->id, request()->input('filter_status', []))) checked
                                                    @endif
                                ...
                                <ul class="space-y-2 text-sm">
                                    <div class="grid grid-cols-2 gap-2 md:grid-cols-3">
                                        @foreach ($paymentMethods as $paymentMethod)
                                            <li class="flex items-center">
                                                <input
                                                    @if (in_array($paymentMethod->id, request()->input('filter_paymentMethod', []))) checked
                                                    @endif
                                                    class="text-primary-600 h-4 w-4 rounded border-gray-300 bg-gray-100 focus:ring-0"
