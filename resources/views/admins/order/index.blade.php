            ...
            <div class="flex flex-shrink-0 flex-col space-y-3 md:flex-row md:items-center md:space-x-3 md:space-y-0 lg:justify-end">
                <form action="{{ route('admin.order.search') }}" class="flex w-full md:w-40 lg:w-64">
                    <div class="relative w-full">
                        ...
                        <input name="tab" type="hidden" value="{{ request('tab') }}">
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    <a class="button-light min-w-40 flex w-full items-center justify-center" href="{{ route('admin.orders.export') }}">
                            ...
                            <td class="flex items-center justify-end px-4 py-3">
                                ...
                                <div class="z-10 hidden w-44 divide-y divide-gray-100 rounded bg-white shadow" id="{{ $order->id }}-dropdown">
                                    <ul aria-labelledby="{{ $order->id }}" class="py-1 text-sm text-gray-700">
                                        <li>
                                            <a class="block px-4 py-2 hover:bg-gray-100" data-modal-target="order-modal-{{ $order->id }}" data-modal-toggle="order-modal-{{ $order->id }}" href="#">Chi
                                                tiết </a>
                                        </li>
                                        <li>
                                                            ...
                                                            <div class="w-full">
                                                                <div class="grid grid-flow-row">
                                                                    <p class="flex justify-between">
                                                                        <span class="text-sm">{{ $orderItem->product->name }}<span class="ps-2 font-medium text-red-600">x{{ $orderItem->quantity }}</span></span>
