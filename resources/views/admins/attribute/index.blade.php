                    ...
                    <tr class="border-b hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2 text-gray-900 whitespace-nowrap font-medium">
                            <span class="flex items-center">
                                <div
                                    class="indicator  {{$attribute->status == 1 ? "bg-green-700" : "bg-red-700"}} inline-block">
                                </div>
                                {{ $attribute->name }} ({{ $attribute->category->name }})
                            </span>
                        </td>
                        <td class="px-4 py-2 text-gray-900 whitespace-nowrap" colspan="2"></td>
                    ...
                    @foreach ($attribute->values as $value)
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2 text-gray-900 whitespace-nowrap">
                                {{ number_format($value->price) }} {{ $value->price_type == 1 ? '₫' : '%' }}</td>
