        ...
        <form action="{{ route('admin.toppings.store') }}" class="w-full" method="post" enctype="multipart/form-data">
            ...
            <div class="flex justify-between gap-2">
                <div class="w-full mb-5">
                    ...
                    <input type="text" name="name" class="input mb-2" value="{{ old('name') }}" />
                    @error('name')
                ...
                <div class="w-full mb-5">
                    ...
                    <input type="number" name="quantity" class="input mb-2" value="{{ old('quantity') }}" />
                    @error('quantity')
                        <span style="color: red ">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex justify-between gap-2 mt-4">
                <div class="w-full mb-5">
                    ...
                    <input type="number" name="price" class="input mb-2" value="{{ old('price') }}" />
                    @error('price')
                        <span style="color: red">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="w-full mb-5">
                <label for="image" class="label-lg">Ảnh thuộc tính <span class="text-red-500">*</span></label>
