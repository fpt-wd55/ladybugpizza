            ...
            <form action="{{ route('admin.toppings.update', $editTopping) }}" class="w-full" method="post"
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="">
                        ...
                        <input type="number" name="quantity" id="quantity" class="input" placeholder="VD: 13" min="0"
                               max="9999"
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div class="">
                        ...
                        <input type="number" name="price" id="price" class="input" placeholder="VD: 18000" min="0"
                               step="1000"
