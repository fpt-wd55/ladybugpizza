            ...
            <form action="{{ route('admin.combos.update', $combo) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-1">
                    <div class="grid gap-4 mb-2 sm:grid-cols-3">
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                   placeholder="VD: Mua 1 Tặng 1 - Tiết Kiệm Nhân Đôi"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            <label for="is_featured" class="label-md">Ảnh combo <span
                        ...
                        <div>
                            ...
                            <div class="w-full border border-gray-200 rounded-lg bg-gray-50">
                                <textarea id="wysiwygeditor"
                                          name="description">{{ old('description', $combo->description) }}</textarea>
                            </div>
                            @error('description')
                            <p class="mt-2 text-sm text-red-600 ">
                                {{ $message }}
