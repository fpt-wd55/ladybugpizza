        ...
        <form action="{{ route('admin.profiles.update', $user) }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="mb-6 grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="password" class="input mb-2" name="current_password" placeholder="Nhập mật khẩu hiện tại"
                ...
                <div>
                    ...
                    <input class="input mb-2" name="new_password" type="password" placeholder="Nhập mật khẩu mới">
                    @error('new_password')
                        <span class="text-sm text-red-500">{{ $message }}</span>
                    @enderror
                </div>
