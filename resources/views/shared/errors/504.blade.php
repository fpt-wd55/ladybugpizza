    ...
    <div class="bg-gray-100">
        <div class="flex items-center justify-center min-h-screen bg-gray-100">
            <div class="text-center p-2">
                ...
                <p class="text-sm md:text-xl font-medium text-gray-500 mb-8">Thời gian chờ kết nối đã hết. Vui lòng thử lại
                    sau hoặc liên hệ với chúng tôi nếu vấn đề tiếp tục.</p>
