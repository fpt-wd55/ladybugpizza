            ...
            <div class="mb-12 p-4 md:p-8">
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-5">
                                    ...
                                    <div class="flex items-start justify-start">
                                        ...
                                        <div class="ms-2 flex w-full flex-col justify-between">
                                            <div class="item-center mb-1 flex justify-between">
                                                <p class="font-bold">{{ $item->product->name }}<span class="ps-2 text-sm font-normal">
                                                        x{{ $item->quantity }}
                                                    </span></p>
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="flex items-center justify-between">
                            <a class="text-sm font-medium text-gray-800 hover:underline" href="{{ route('client.contact') }}">Giỏ
                                hàng</a>
