                    ...
                    <div class="block items-center justify-start md:flex">
                        <div class="inline-block w-20 rounded-md border border-gray-200 bg-white px-3 py-2 md:w-28">
                            <div class="flex items-center justify-center gap-x-1.5">
                                ...
                                <input class="w-6 border-0 bg-transparent p-0 text-center text-sm font-medium text-gray-800 focus:ring-0" id="quantity" min="1" name="quantity" style="appearance: textfield; -moz-appearance: textfield;" type="hidden" value="1">
                                <p class="w-6 border-0 bg-transparent p-0 text-center text-sm font-medium text-gray-800 focus:ring-0" id="show_quantity"></p>
