...
<div class="mx-auto px-0">
    <div class="md:mx-24 lg:mx-32 min-h-screen p-4 md:p-8 transition">
        ...
        <div class="text-center">
            <p class="vujahday-script-regular text-5xl text-center">Ladybug Pizza</p>
        </div>
        ...
        <div class="mb-32">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <a href="{{ route('client.product.show', $product->slug) }}" class="product-card md:flex overflow-hidden">
                    <img loading="lazy" src="{{ asset('storage/uploads/products/pizza/' . $product->image) }}" class="flex-shrink-0 h-48 w-full md:w-1/3 md:h-full object-cover" alt="">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 mb-32 gap-8">
            ...
            <img loading="lazy" src="{{ asset('storage/uploads/products/pizza/pizza-5-cheese.jpeg') }}" class="flex-shrink-0 h-full w-full rounded-lg object-cover" alt="">
        </div>

        {{-- Cau chuyen cua chung toi --}}
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="grid grid-cols-2 grid-rows-2 gap-4">
                <img loading="lazy" src="{{ asset('storage/uploads/products/pizza/pizza-margherita.jpeg') }}" class="h-full w-full rounded-lg object-cover" alt="">
                <img loading="lazy" src="{{ asset('storage/uploads/products/pizza/pizza-4-cheese.jpeg') }}" class="h-full w-full rounded-lg object-cover" alt="">
                <img loading="lazy" src="{{ asset('storage/uploads/products/pizza/pizza-burrata-cay.jpeg') }}" class="h-full w-full rounded-lg object-cover" alt="">
                <img loading="lazy" src="{{ asset('storage/uploads/products/pizza/pizza-ca-hoi.jpg') }}" class="h-full w-full rounded-lg object-cover" alt="">
            </div>
            <div class="text-center">
                <p class="text-center berkshire-swash-regular text-3xl lg:text-4xl mb-4">Khám Phá</p>
